    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-100 p-4">
      <form action="#" className="mx-auto w-full max-w-lg space-y-4 rounded-2xl p-6 shadow-xl border-2 bg-white border-neutral-200">
        <h1 className="text-3xl font-bold text-black font-semibold text-center mb-4">Create Account</h1>
          <div>
            <label className="block text-lg font-medium leading-6" htmlFor="firstName">First Name</label>
          ...
          <div>
            <label className="block text-lg font-medium leading-6" htmlFor="lastName">Last Name</label>
        ...
        <div>
          <label className="block text-lg font-medium leading-6" htmlFor="address">Address</label>
