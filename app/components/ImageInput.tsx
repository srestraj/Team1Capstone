...
import { ImageInputProps } from "../utils/types/ImageInput";
...
const ImageInput = ({
  ...
  const handleImgUrlInput = (event: FormEvent<HTMLInputElement>) => {
    handleUrlInput((event.target as HTMLInputElement).value);
  };
  ...
  return (
    <div className="w-full">
      ...
      >
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">{title}</span>
        {isInput && (
          <button
