const Footer = () => {
  ...
  {/* Grey background section - Footer content */}
  <div className="bg-[#F0F0F0] ">

      {/* Main Footer Content */}
      <div className="mx-auto max-w-7xl px-4 pt-40 pb-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="mt-6 flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-black hover:bg-black hover:text-white transition bg-white">
